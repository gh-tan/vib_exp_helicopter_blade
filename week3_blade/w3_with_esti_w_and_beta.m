...
den_out=conv([1 2*beta1_out*w2_out w2_out^2],[1 2*beta1_out*w3_out w3_out^2]);
...
num_out=[1 2*beta2_out*w1_out w1_out^2];
den_out=conv([1 2*beta2_out*w2_out w2_out^2],[1 2*beta2_out*w3_out w3_out^2]);
Hij_out=K_out*w2_out^2*w3_out^2/w1_out^2*tf(num_out,den_out);
...
w3_out = csvread('45degrees.csv',21,0,[21 0 171 3]); %<< switch the file name
freq_out = w3_out(:,1);
ch1_out = w3_out(:,2);
ch2_out = w3_out(:,3);
G_out = ch2_out - ch1_out;
...
num_out=[1 2*beta3_out*w1_out w1_out^2];
den_out=conv([1 2*beta3_out*w2_out w2_out^2],[1 2*beta3_out*w3_out w3_out^2]);
Hij_out=K_out*w2_out^2*w3_out^2/w1_out^2*tf(num_out,den_out);
